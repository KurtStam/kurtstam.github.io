...
Set _export KUBERNETES_MASTER=http://rpi-master:8080_ so your _kubectl_ can connect the kubernetes REST API on the master. Now  verify your nodes are registered
....
kubectl get nodes
NAME         LABELS                              STATUS
