...
Finally you need to point the node to its master. Edit the _/etc/systemd/system/kubelet.service_ file and add the master's Kubernetes REST endpoint to the 'api-servers'.
