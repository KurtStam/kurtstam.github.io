...
CAUTION: Before you start edit the Vagrantfile, and set the max memory and number of cpu's to about half of what your machine has, or else your machine might become *really* slow later.
